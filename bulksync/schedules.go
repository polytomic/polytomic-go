...
type CreateScheduleRequest struct {
	Schedule *v25.BulkSyncScheduleAPI `json:"schedule" url:"-"`
...
func (c *CreateScheduleRequest) SetSchedule(schedule *v25.BulkSyncScheduleAPI) {
	c.Schedule = schedule
...
// SetSchedule sets the Schedule field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpdateScheduleRequest) SetSchedule(schedule *v25.BulkSyncScheduleAPI) {
	u.Schedule = schedule
