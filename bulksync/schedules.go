...
type CreateScheduleRequest struct {
	Schedule *polytomicgo.V4BulkSyncScheduleApi `json:"schedule" url:"-"`
...
func (c *CreateScheduleRequest) SetSchedule(schedule *polytomicgo.V4BulkSyncScheduleApi) {
	c.Schedule = schedule
...
// SetSchedule sets the Schedule field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpdateScheduleRequest) SetSchedule(schedule *polytomicgo.V4BulkSyncScheduleApi) {
	u.Schedule = schedule
