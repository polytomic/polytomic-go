...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Version", "v25.9.0")
	headers.Set("User-Agent", "github.com/polytomic/polytomic-go/25.9.0")
	return headers
}
...
func (v *VersionOption) applyIdempotentRequestOptions(opts *IdempotentRequestOptions) {
	opts.Version = v.Version
}
