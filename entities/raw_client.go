...
func (r *RawClient) Get(
...
) (*core.Response[*polytomic.EntityResponseEnvelope], error) {
	...
	var response *polytomic.EntityResponseEnvelope
	...
	return &core.Response[*polytomic.EntityResponseEnvelope]{
...
func (r *RawClient) GetForPartner(
	ctx context.Context,
	// UUID of the entity to resolve.
	id string,
	opts ...option.RequestOption,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/api/organizations/entities/%v",
		id,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
