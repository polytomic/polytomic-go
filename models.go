...
var (
	enrichmentInputFieldsRequestFieldConfiguration = big.NewInt(1 << 0)
)

type EnrichmentInputFieldsRequest struct {
	Configuration *EnricherConfiguration `json:"configuration,omitempty" url:"-"`

	// Private bitmask of fields set to an explicit value and therefore not to be omitted
	explicitFields *big.Int `json:"-" url:"-"`
}

func (e *EnrichmentInputFieldsRequest) require(field *big.Int) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (e *EnrichmentInputFieldsRequest) SetConfiguration(configuration *EnricherConfiguration) {
	e.Configuration = configuration
	e.require(enrichmentInputFieldsRequestFieldConfiguration)
}

func (e *EnrichmentInputFieldsRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler EnrichmentInputFieldsRequest
	var body unmarshaler
	if err := json.Unmarshal(data, &body); err != nil {
		return err
	}
	*e = EnrichmentInputFieldsRequest(body)
	return nil
}

func (e *EnrichmentInputFieldsRequest) MarshalJSON() ([]byte, error) {
	type embed EnrichmentInputFieldsRequest
...
type EnricherConfiguration = map[string]any
...
type EnricherMapping = map[string]string
...
type Enrichment struct {
	Configuration *EnricherConfiguration `json:"configuration,omitempty" url:"configuration,omitempty"`
	...
	Mappings *EnricherMapping `json:"mappings,omitempty" url:"mappings,omitempty"`
...
func (e *Enrichment) GetConfiguration() *EnricherConfiguration {
	if e == nil {
		return nil
	}
...
func (e *Enrichment) GetMappings() *EnricherMapping {
	if e == nil {
		return nil
	}
	return e.Mappings
...
// SetConfiguration sets the Configuration field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (e *Enrichment) SetConfiguration(configuration *EnricherConfiguration) {
	e.Configuration = configuration
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (e *Enrichment) SetMappings(mappings *EnricherMapping) {
	e.Mappings = mappings
...
var (
	getEnrichmentInputFieldsResponseEnvelopeFieldData = big.NewInt(1 << 0)
)

type GetEnrichmentInputFieldsResponseEnvelope struct {
...
func (g *GetEnrichmentInputFieldsResponseEnvelope) GetData() [][]string {
	if g == nil {
		return nil
	}
	return g.Data
...
func (g *GetEnrichmentInputFieldsResponseEnvelope) GetExtraProperties() map[string]interface{} {
	if g == nil {
		return nil
	}
...
func (g *GetEnrichmentInputFieldsResponseEnvelope) require(field *big.Int) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetEnrichmentInputFieldsResponseEnvelope) SetData(data [][]string) {
	g.Data = data
	g.require(getEnrichmentInputFieldsResponseEnvelopeFieldData)
}

func (g *GetEnrichmentInputFieldsResponseEnvelope) UnmarshalJSON(data []byte) error {
	type unmarshaler GetEnrichmentInputFieldsResponseEnvelope
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GetEnrichmentInputFieldsResponseEnvelope(value)
...
func (g *GetEnrichmentInputFieldsResponseEnvelope) MarshalJSON() ([]byte, error) {
	type embed GetEnrichmentInputFieldsResponseEnvelope
	var marshaler = struct {
		embed
	}{
		embed: embed(*g),
...
func (g *GetEnrichmentInputFieldsResponseEnvelope) String() string {
	if g == nil {
		return "<nil>"
	}
	if len(g.rawJSON) > 0 {
...
type ModelSample struct {
	Records  []SampleRecord `json:"records,omitempty" url:"records,omitempty"`
...
func (m *ModelSample) GetRecords() []SampleRecord {
	if m == nil {
		return nil
	}
	return m.Records
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (m *ModelSample) SetRecords(records []SampleRecord) {
	m.Records = records
...
type SampleRecord = map[string]map[string]any
