...
func (r *RawClient) Post(
...
) (*core.Response[*polytomic.GetEnrichmentInputFieldsResponseEnvelope], error) {
	...
	var response *polytomic.GetEnrichmentInputFieldsResponseEnvelope
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*polytomic.GetEnrichmentInputFieldsResponseEnvelope]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
