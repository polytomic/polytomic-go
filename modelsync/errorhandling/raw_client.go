...
func (r *RawClient) Get(
...
) (*core.Response[*polytomic.SyncErrorHandlingEnvelope], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/api/syncs/%v/error-handling",
		id,
	)
	...
	var response *polytomic.SyncErrorHandlingEnvelope
	...
	return &core.Response[*polytomic.SyncErrorHandlingEnvelope]{
