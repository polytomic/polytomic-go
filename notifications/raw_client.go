...
func (r *RawClient) GetGlobalErrorSubscribers(
...
) (*core.Response[*polytomic.GlobalErrorSubscribersResponse], error) {
	...
	var response *polytomic.GlobalErrorSubscribersResponse
	...
	return &core.Response[*polytomic.GlobalErrorSubscribersResponse]{
