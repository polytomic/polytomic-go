...
package temporary_credentials_test
...
func TestTemporaryCredentialsCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.TemporaryCredentials.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTemporaryCredentialsCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTemporaryCredentialsCreateWithWireMock", "POST", "/api/temporary-credentials", nil, 1)
}
