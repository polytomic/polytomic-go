...
func (r *RawClient) ListCurrentOrgUsers(
	...
	endpointURL := baseURL + "/api/organization/users"
...
func (r *RawClient) CreateCurrentOrgUser(
	ctx context.Context,
...
func (r *RawClient) GetCurrentOrgUser(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/api/organization/users/%v",
		id,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) UpdateCurrentOrgUser(
	ctx context.Context,
